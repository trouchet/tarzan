...
def getTypeField(type_field, max_length_value, is_required, label, input_type, validators_list):
    return type_field(
        max_length=max_length_value,
        required=is_required,
        widget=input_type(attrs={'placeholder': labelInput(label, is_required), 'class': 'form-control'}),
...
class CustomUserCreationForm(UserCreationForm):
    ...
    password = getTypeField(CharField, 150, True, 'Password', PasswordInput, password_validators)
